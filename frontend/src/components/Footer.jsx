      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-sm text-gray-600">
            © {new Date().getFullYear()} <span className="font-semibold text-gray-900">Tharun Subramanian C</span>
          </div>
          <div className="flex items-center gap-6">
            <a
              href="https://github.com/C-Tharun"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-all duration-200 group"
            ...
            <a
              href="https://www.linkedin.com/in/tharun-c/"
              target="_blank"
              rel="noopener noreferrer"
